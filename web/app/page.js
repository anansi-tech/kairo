    ...
    <>
      ...
      >
        ...
        <div className="relative max-w-[960px] mx-auto text-center">
          <p className="text-[11px] tracking-[0.3em] uppercase text-kairo-bronze font-semibold mb-7 animate-fade-up animate-fade-up-delay-1">
            Kairo by Anansi · Executive AI Education
          </p>
          <h1 className="font-display text-[clamp(44px,7vw,86px)] leading-[1.02] text-kairo-navy animate-fade-up animate-fade-up-delay-1">
            Stop reading about AI.
            <br />
            <span className="italic text-kairo-bronze">Start using it.</span>
          </h1>
          <p className="mt-8 text-[17px] sm:text-[19px] text-kairo-navy/75 leading-[1.6] max-w-[680px] mx-auto animate-fade-up animate-fade-up-delay-2">
          ...
          <div className="mt-10 flex flex-col sm:flex-row items-center justify-center gap-4 animate-fade-up animate-fade-up-delay-3">
            <a
              href="#cta"
              className="inline-flex items-center gap-2 px-8 py-4 bg-kairo-bronze text-kairo-paper
                         text-[13px] tracking-[0.1em] uppercase font-semibold rounded-sm
                         hover:bg-kairo-navy transition-colors min-w-[260px] justify-center"
            >
              Get notified about the next cohort →
            </a>
            <a
              href="#what-you-learn"
              className="text-[13px] tracking-[0.1em] uppercase text-kairo-navy/65
                         hover:text-kairo-bronze transition-colors"
            >
              See what you learn
            </a>
          </div>
      ...
      <section
        id="what-you-learn"
        className="py-24 md:py-28 px-6 md:px-12 border-t border-kairo-navy/10"
      >
        <div className="max-w-[1200px] mx-auto reveal">
          <Eyebrow>What you learn</Eyebrow>
          <h2 className="font-display text-[clamp(32px,4.5vw,56px)] leading-[1.1] text-kairo-navy max-w-[700px]">
            Two days. <span className="italic text-kairo-bronze">Real tools, real work.</span>
          </h2>
      ...
      <section
        id="who-its-for"
        className="py-24 md:py-28 px-6 md:px-12 border-t border-kairo-navy/10 bg-kairo-paper"
      >
        <div className="max-w-[1200px] mx-auto reveal">
          <Eyebrow>Who it's for</Eyebrow>
          <h2 className="font-display text-[clamp(28px,3.6vw,44px)] leading-[1.15] text-kairo-navy max-w-[820px]">
            Working professionals who&apos;ve heard about AI everywhere — and are quietly worried
            they don&apos;t actually know how to use it.
          </h2>
          <p className="mt-7 text-[17px] text-kairo-navy/75 leading-[1.75] max-w-[760px]">
      ...
      <section className="py-24 md:py-28 px-6 md:px-12 border-t border-kairo-navy/10">
        <div className="max-w-[1200px] mx-auto reveal">
          <Eyebrow>What makes it different</Eyebrow>
          <h2 className="font-display text-[clamp(28px,3.6vw,44px)] leading-[1.15] text-kairo-navy max-w-[760px]">
            Not another deck. Not another &ldquo;framework.&rdquo;
            <br />
            <span className="italic text-kairo-bronze">Built by an operator.</span>
          </h2>
      ...
      {/* ===== FORMAT & PRICING ===== */}
      <section className="py-24 md:py-28 px-6 md:px-12 border-t border-kairo-navy/10 bg-kairo-navy text-kairo-paper">
        <div className="max-w-[1200px] mx-auto reveal">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-px bg-kairo-paper/10 mt-14">
          ...
          <p className="mt-8 text-sm text-kairo-bronze/85 max-w-[640px] mx-auto leading-[1.6] text-center">
      ...
      >
        <div className="max-w-[1200px] mx-auto grid md:grid-cols-[280px_minmax(0,1fr)] gap-12 md:gap-16 items-start reveal">
          <div className="flex flex-col items-center md:items-start">
            <div className="w-[200px] h-[200px] md:w-[240px] md:h-[240px] rounded-full bg-kairo-paper border-2 border-kairo-gold shadow-[0_24px_48px_rgba(15,39,66,0.18)] flex items-center justify-center">
              {/* TODO: replace with David's headshot when provided. */}
              <span className="font-display text-[64px] md:text-[80px] text-kairo-bronze leading-none">
                DN
              </span>
            </div>
            <p className="mt-5 text-[12px] tracking-[0.18em] uppercase text-kairo-navy/60">
              Your instructor
            </p>
          </div>
      ...
      <section
        id="cta"
        className="py-28 md:py-32 px-6 md:px-12 border-t border-kairo-navy/10 bg-kairo-paper relative overflow-hidden"
      >
        <div
          className="absolute inset-0 pointer-events-none"
          style={{
        ...
        <div className="max-w-[760px] mx-auto text-center relative reveal">
          ...
          <h2 className="font-display text-[clamp(32px,4.5vw,56px)] leading-[1.1] text-kairo-navy">
            Get notified when the next cohort opens.
          </h2>
          <p className="mt-6 text-[17px] text-kairo-navy/75 leading-[1.7] max-w-[580px] mx-auto">
...
function Eyebrow({ children, center }) {
  return (
    <div className={`flex items-center gap-3 mb-6 ${center ? "justify-center" : ""}`}>
      <span className="block w-8 h-px bg-kairo-bronze" />
      <p className="text-[10px] tracking-[0.25em] uppercase text-kairo-bronze font-semibold">
        {children}
      </p>
    </div>
  );
...
function DayCard({ num, title, items }) {
  return (
    <div className="border-t border-kairo-navy/15 pt-7">
      <p className="text-[11px] tracking-[0.2em] uppercase text-kairo-bronze font-semibold">
        {num}
      </p>
      <h3 className="font-display text-[26px] md:text-[30px] leading-[1.2] text-kairo-navy mt-3">
        {title}
      </h3>
      <ul className="mt-7 space-y-4">
        {items.map((item, i) => (
          <li key={i} className="flex gap-3 items-baseline">
            <span className="text-kairo-bronze text-[11px] font-mono shrink-0 mt-[3px]">
              {String(i + 1).padStart(2, "0")}
            </span>
            <p className="text-[15px] text-kairo-navy/85 leading-[1.65]">{item}</p>
          </li>
        ))}
      </ul>
    </div>
...
function Persona({ role, quote }) {
  return (
    <div className="border border-kairo-navy/12 bg-kairo-paper p-7 rounded-sm">
      <p className="text-[10px] tracking-[0.18em] uppercase text-kairo-bronze font-semibold mb-4">
        {role}
      </p>
      <p className="text-[15px] text-kairo-navy/85 leading-[1.65] italic">
        &ldquo;{quote}&rdquo;
      </p>
    </div>
  );
...
function Moat({ title, children }) {
  return (
    <div>
      <h3 className="font-display text-[22px] md:text-[24px] text-kairo-navy italic">
        {title}
      </h3>
      <p className="mt-3 text-[15px] text-kairo-navy/80 leading-[1.75]">{children}</p>
    </div>
  );
}
...
function Stat({ label, value, sub }) {
  return (
    <div className="bg-kairo-navy p-6 md:p-7">
      <p className="text-[10px] tracking-[0.18em] uppercase text-kairo-gold/70 mb-3">{label}</p>
      <p className="font-display text-[clamp(28px,3.4vw,40px)] leading-none text-kairo-paper">
        {value}
      </p>
      <p className="text-[11px] tracking-[0.1em] uppercase text-kairo-paper/55 mt-3">{sub}</p>
    </div>
  );
}
...
function PriceTile({ primary, label }) {
  return (
    <div className="border border-kairo-paper/15 px-6 py-6 rounded-sm">
      <p className="font-display text-[28px] md:text-[32px] text-kairo-gold leading-none">
        {primary}
      </p>
      <p className="text-[12px] tracking-[0.08em] uppercase text-kairo-paper/70 mt-3">{label}</p>
    </div>
  );
}
